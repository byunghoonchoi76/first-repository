...
// 7. 기도 알림 (신규)
sections.push(section({ badge: '🔔', color: AMBER, kicker: '기도 · 새 기능', title: '기도 알림',
  body: phone('reminders.png', '기도 알림 설정') + desc([
    { t: '정한 **요일과 시간**에 “기도할 시간이에요 🙏” 알림을 휴대폰으로 받습니다.' },
    { h: '켜는 방법' },
    { t: '기도 탭 → **기도 알림**으로 들어가 **알림 켜기**를 누르고 권한을 **허용**합니다.' },
    { t: '**요일**(여러 개 가능)을 켜고, **시간**은 [[오전]]/[[오후]] · **시(1~12)** · **분(00~59)** 으로 정한 뒤 **저장**.' },
    { t: '**테스트 알림 보내기**로 알림이 잘 뜨는지 바로 확인할 수 있어요.' },
  ]) + tip('· 안드로이드/PC는 브라우저에서 바로 옵니다. · 아이폰은 **사파리 → 홈 화면에 추가**로 설치한 앱에서 열어야 알림이 옵니다. · 소리+진동은 휴대폰을 **진동/소리+진동 모드**로 두거나 앱 알림을 “소리 및 진동”으로 설정하세요.') }));

// 8. 소그룹
sections.push(section({ badge: '👥', color: TEAL, kicker: '아래 탭 · 소그룹', title: '소그룹',
  body: phone('groups.png', '소그룹') + desc([
    { t: '소그룹(구역·목장)을 소개하고 대화를 나누는 곳입니다.' },
    { t: '소그룹을 누르면 **모임 안내와 소통방**으로 들어갑니다.' },
    { t: '대화는 **로그인한 성도**만 읽고 쓸 수 있어요.' },
  ]) }));
...
sections.push(section({ badge: '🌸', color: NAVY, kicker: '기도 · 기도제목 나눔', title: '개인 기도제목 · 기도 요청',
  body: phones([{ src: 'prayer_topics.png', cap: '개인 기도제목' }, { src: 'prayer_requests.png', cap: '기도 요청' }]) + desc([
    { h: '개인 기도제목' },
    { t: '**나만 보는** 기도제목을 적고 관리합니다. **기도제목 추가**로 새 제목을 적어요. (익명 여부 선택 가능)' },
    { t: '응답되면 **기도 응답되었어요**로 표시할 수 있어요.' },
    { h: '기도 요청' },
    { t: '개인 기도제목에서 **기도 요청으로 올리기**를 누르면 이 목록에 공개됩니다.' },
    { t: '성도들이 [[함께 기도]]를 눌러 함께 기도할 수 있어요.' },
  ]) }));
...
sections.push(section({ badge: '🛠', color: NAVY, kicker: '관리자 전용', title: '관리자 기능',
  body: phones([
    ...
    { t: '**더보기 → 관리자 화면 열기**에서 전체 관리로 들어갑니다.' },
    { t: '주보·공지(소식)·설교·섬기는 사람들·소그룹·공동 기도제목을 **추가·수정·삭제**.' },
...
const html = `<!doctype html><html lang="ko"><head><meta charset="utf-8"><style>
  ...
  * { box-sizing: border-box; }
  ...
  <div class="cover"><div class="logo">⛪</div><h1>구리 목양교회 앱 사용설명서</h1><div class="sub">화면별 사용 안내 · 2026-09-07</div></div>
